# Результат выполнения тестового задания Aviasales
...
В рамках тестового задания зафиксируем, что длительность полета для билета — это суммарная длительность полетов в обоих направлениях для каждого билета.
...
В рамках тестового задания будем считать, что операция фильтрации билетов — это дорогостоящая операция с точки зрения вычислительных ресурсов, поэтому с целью экономии ресурсов применим методику кэширования.
...
Для тестового задания установлены мета-данные реального приложения в продакшене (мета-теги в HTML и фавиконки).
